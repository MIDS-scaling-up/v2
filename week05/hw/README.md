...
* If you see errors in the `buffer_size=AUTOTUNE` related cell, just comment out AUTOTUNE and set buffer_size to 32 . Apparently, Colab uses TF 2.4 and we only have 2.3 on the Jetson.
