...
#sudo docker run -e DISPLAY=$DISPLAY --privileged -v /home/sairavuru/Documents/v2/week03/hw/HW3/Cam5/:/tmp --rm --env QT_X11_NO_MITSHM=1 face_detect python ./video_read.py
...
while(True):
	...
	for (x,y,w,h) in faces:
		...
		#cv2.imwrite("face-" + str(i) + ".jpg", gray)
		#cv2.imshow('frame',gray)
		#i += 1
